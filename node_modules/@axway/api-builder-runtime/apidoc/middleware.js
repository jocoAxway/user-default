 ...
 * by the API Builder Web components. To access the middleware instance, use the API Builder instance's
 * `middleware` property.
 *
 * ### Renderer Engines
 *
 * API Builder provides renderer engines for EJS, Handlebars, HTML, Markdown and React templates.
 * The renderer engines are used by the API Builder Web component to render HTML to a web client.
 * To access the renderers, use the {@link APIBuilder.Middleware#static-method-getRendererEngine getRendererEngine()}
 ...
 * {@link APIBuilderRendererEngine#createRenderer createRenderer()} method and specifies the
 * {@link APIBuilderRendererEngine#extension extension}. Pass the object to the Middleware instance's
 * {@link APIBuilder.Middleware#registerRendererEngine registerRendererEngine())} method.
 *
...
/**
 * @class APIBuilderRendererEngine
 ...
 *
 * API Builder provides the renderer engines for the following template formats:
 *
