...
class EndpointsAPI extends APIProvider {
	...
	static bind(controller) {
		...
		swagger
			...
			.response(200, 'Validation completed', Endpoints.schema, false)
			.response(400)
			.response(413)
			.response(500)
			.action(
				(req, res) => {
					controller.validateEndpoint(req.fields, req.files)
						.then(result => {
		...
		swagger
			...
			.action((req, res) => {
				...
				controller.getEndpointSummaries(opts)
					.then(summaries => {
		...
		swagger
			...
			.response(204, 'Flow successfully bound')
			.response(400)
